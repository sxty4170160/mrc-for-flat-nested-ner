...
from data.data_utils.file_utils import load_conll 
from data.data_utils.label_utils import get_span_labels 
from data.query_collections.query_map import queries_for_dataset
...
if __name__ == "__main__":
    # test for nested ner 
    source_file_path = "/data/nfsdata2/xiaoya/data_repo/data-mrc_ner/nested/ace2005/test.ace05.json"
    target_file_path = "/home/lixiaoya/testaec2005.json"
    entity_sign = "nested"
    dataset_name = "en_ace2005"
    query_sign = "default" # "labels", "synomous", ""
    ...
    # test for flat ner 
    source_file_path = "/data/nfsdata2/xiaoya/data_repo/data-mrc_ner/flat/msra_zh/test.char.bmes"
    target_file_path = "/home/lixiaoya/test_msra"
    entity_sign = "flat"
